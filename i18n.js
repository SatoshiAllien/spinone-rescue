...
(function () {
  ...
  var PHOTOS = {
    ...
    p20: { it: { caption: 'Paola con uno Spinone durante una passeggiata nel prato', alt: 'Paola con giubbotto arancione e uno Spinone Italiano in un campo verde', overlay: 'Passeggiata nel prato' }, en: { caption: 'Paola with a Spinone during a walk in the meadow', alt: 'Paola in an orange vest with an Italian Spinone in a green field', overlay: 'Meadow walk' } },
    p21: { it: { caption: 'Paola e uno Spinone in un momento di tranquillità all\'aperto', alt: 'Paola e uno Spinone Italiano in un prato con erba alta', overlay: 'Momento di pace' }, en: { caption: 'Paola and a Spinone in a peaceful outdoor moment', alt: 'Paola and an Italian Spinone in a tall grass meadow', overlay: 'Peaceful moment' } },
    p22: { it: { caption: 'Primo piano di uno Spinone bianco in un ambiente interno', alt: 'Primo piano ravvicinato di uno Spinone Italiano bianco con barba folta', overlay: 'Il nostro Spinone' }, en: { caption: 'Close-up of a white Spinone in an indoor setting', alt: 'Close-up of a white Italian Spinone with a bushy beard', overlay: 'Our Spinone' } },
    p23: { it: { caption: 'Un veterinario effettua una procedura medica su uno Spinone', alt: 'Veterinario con guanti che cura la zampa di uno Spinone Italiano bianco', overlay: 'Cure mediche' }, en: { caption: 'A vet performing a medical procedure on a Spinone', alt: 'Vet in gloves treating the paw of a white Italian Spinone', overlay: 'Medical care' } },
    p24: { it: { caption: 'Lavori di ristrutturazione e miglioramento dell\'area del rifugio', alt: 'Cantiere con assi di legno e materiali per la ristrutturazione del rifugio', overlay: 'Ristrutturazione rifugio' }, en: { caption: 'Renovation and improvement work at the shelter area', alt: 'Construction site with wooden planks and materials for shelter renovation', overlay: 'Shelter renovation' } }
  };
